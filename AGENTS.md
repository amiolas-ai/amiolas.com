...
> ⚠ Next.js 16은 v15에서 다수 breaking change. v16 함정·캐시·서버/클라이언트 규칙은 `node_modules/next/dist/docs/`의 관련 가이드를 우선 참조합니다.
...
라우팅·서버/클라이언트 경계·데이터 페칭/캐싱·폼 처리 등 코드 작성 규칙은 `node_modules/next/dist/docs/`의 관련 가이드를 우선 확인합니다.
