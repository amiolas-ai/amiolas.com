export function MissionBar() {
  return (
    <section
      className="mission-stripes relative overflow-hidden border-y border-dashed border-border px-[var(--pad)] py-section-sm"
      style={{
        background:
    ...
    >
      <div className="relative mx-auto max-w-[1440px] text-center">
        <div className="mb-7 font-mono text-label uppercase text-fg-dim">
          Metaphor
        </div>
        ...
        <div className="mt-9 flex flex-col items-center justify-center gap-1.5 font-mono text-label uppercase text-fg-dim sm:flex-row sm:gap-3">
